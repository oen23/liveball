...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // ЗАМЕНИТЬ НА → POST /api/auth/register
    //
    ...
    //   return;
    // }
    // navigate("/");  // Перенаправляем на логин после успешной регистрации
    // ═══════════════════════════════════════════════════════════════════════
      ...
      <div className="w-full max-w-md">
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label htmlFor="confirm" className="block text-sm text-slate-300 mb-2">Confirm Password</label>
              <input
                id="confirm"
                type="password"
                value={confirm}
